...
const DUMMY_ASSETS: Asset[] = [
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1570197662369-d4859d45c1d6?w=400&h=400&fit=crop'],
    condition: 'Good',
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1523348837708-15d4a09cfac2?w=400&h=400&fit=crop'],
    condition: 'New',
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1486406146926-c627a92ad1ab?w=400&h=400&fit=crop'],
    condition: 'Good',
